...
import x7c1.linen.glue.res.layout.{UnreadOutlineSource, UnreadDetailRow, UnreadOutlineEntry, MainLayout, MenuRowLabel, MenuRowTitle, MenuRowSeparator, UnreadSourceRow}
...
class UnreadRowProviders(
  ...
  val forOutlineSource: ViewHolderProvider[UnreadOutlineSource],
  val forOutlineEntry: ViewHolderProvider[UnreadOutlineEntry],
