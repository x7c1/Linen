...
import x7c1.linen.glue.res.layout.{UnreadDetailRow, UnreadOutlineEntry, MainLayout, MenuRowLabel, MenuRowTitle, MenuRowSeparator, UnreadSourceRow}
...
class UnreadRowProviders(
  ...
  val forOutline: ViewHolderProvider[UnreadOutlineEntry],
